...
public class UsingFragmentsTool extends Tool implements ToolDescriptor {

    private final Context context;

    public UsingFragmentsTool(Context context) {
    ...
    public void onActivate(Activity arg0, MapView arg1, ViewGroup arg2,
        ...
        Intent i = new Intent(
                UsingFragmentsDropDownReceiver.SHOW_PLUGIN);
