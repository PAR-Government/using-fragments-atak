...
public class UsingFragmentsMapComponent extends DropDownMapComponent {

    private static final String TAG = "UsingFragmentsMapComponent";

    private Context pluginContext;

    private UsingFragmentsDropDownReceiver ddr;
